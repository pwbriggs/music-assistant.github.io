...
Announcements are either Text-to-Speech or audio files that are sent to the MA players via the [`tts.xxxxxx`](https://www.home-assistant.io/integrations/tts/) or [`mass.play_announcement`](../faq/massannounce.md) HA actions. 
